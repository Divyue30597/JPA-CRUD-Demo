package com.lti.springboot.cruddemo.rest;
...
import com.lti.springboot.cruddemo.service.EmployeeService;
...
public class EmployeeRestController {
	...
	public Employee addEmployee(@RequestBody Employee theEmployee) {
		//pass an id in JSON -> set id tp 0 , this is to force a save of new item ... instead of update
